 ...
 * </ul>
 */
class GetUserByIdSqlTest {

  private static final Logger logger = Logger.getLogger(GetUserByIdSqlTest.class.getName());
  ...
  void setUp() {
    ...
    this.injector = Guice.createInjector(new GetUserByIdSqlTest.GuiceModule());

    TraitBinder traitBinder = new TraitBinder();
    traitBinder.bindTrait(GetUserByIdTrait_Req.class)
        .to(GetUserByIdTrait_sql_Req.class);
