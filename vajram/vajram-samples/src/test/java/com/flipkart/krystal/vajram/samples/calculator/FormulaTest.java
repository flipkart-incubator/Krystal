...
class FormulaTest {
  ...
  void setUp() {
    ...
    this.requestLevelCache = spy(new TestRequestLevelCache(graph));
  ...
  void formula_computeDepFails_failsWithException() {
    ...
    kGraph.inputBatcherConfig(
        simpleInputBatcher(
            graph.getVajramIdByVajramDefType(Add.class), () -> new InputBatcherImpl(100)));
    KrystexVajramExecutorConfigBuilder vajramExecutorConfig =
        KrystexVajramExecutorConfig.builder()
            .kryonExecutorConfig(
                KryonExecutorConfig.builder()
                    .executorId(REQUEST_ID)
  ...
  void formula_success_withAllMockedDependencies() {
    ...
    kGraph.inputBatcherConfig(
        simpleInputBatcher(
            graph.getVajramIdByVajramDefType(Add.class), () -> new InputBatcherImpl(100)));
    KrystexVajramExecutorConfigBuilder executorConfigBuilder =
        KrystexVajramExecutorConfig.builder()
  ...
  void formula_success_with_mockedDependencyAdder() {
    ...
    kGraph.inputBatcherConfig(
        simpleInputBatcher(
            graph.getVajramIdByVajramDefType(Add.class), () -> new InputBatcherImpl(100)));
    KrystexVajramExecutorConfigBuilder kryonExecutorConfigBuilder =
        KrystexVajramExecutorConfig.builder()
            .requestId(REQUEST_ID)
            .kryonExecutorConfig(
                KryonExecutorConfig.builder()
  ...
  private static VajramGuiceInputInjector injectAdderFailure() {
