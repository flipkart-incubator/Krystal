...
public final class UserServiceVajramImpl123 {
  ...
  //
  //  @Override
  //  public InputsConverter<UserServiceInputsNeedingModulation, UserServiceCommonInputs>
  // getInputsConvertor() {
  //    return CONVERTER;
  //  }
  //
  ...
  //      var results = callUserService(new ModulatedInput<>(ImmutableList.copyOf(ims),
  // commonInputs));
