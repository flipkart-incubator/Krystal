  ...
  public DependencyCommand<Inputs> resolveInputOfDependency(
    ...
    if (dependency.equals("hellos")) {
      if (Set.of("user_id").equals(resolvableInputs)) {
        ...
        DependencyCommand<String> depCommand = MultiHelloFriendsV2.userIdsForHellos(userIds, skip);
                          ...
                          hellosResult.values().entrySet().stream()
                              .collect(
                                  toImmutableMap(
                                      ...
                                      Entry::getValue)));
                  return valueOrError(
                      () -> MultiHelloFriendsV2.sayHellos(new MultiHelloFriendsV2AllInputs(userIds, false, hellos)));
                }));
  }
}
