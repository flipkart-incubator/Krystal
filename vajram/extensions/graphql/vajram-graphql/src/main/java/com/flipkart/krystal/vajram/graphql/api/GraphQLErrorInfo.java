 ...
 *
 * <p>This interface provides a clean abstraction layer on top of GraphQLError, allowing error
 * information to be collected and managed independently of the GraphQL-specific error format. This
 * makes it easier to change error structures without affecting the generated code.
 *
 * <p>Usage:
 *
 * <pre>{@code
