 ...
 *
 * <p>This implementation stores {@link GraphQLErrorInfo} instances internally
 * and converts them to {@link GraphQLError} instances when {@link #getErrors()} is called.
 * This provides a clean abstraction layer between error collection and the GraphQL-specific
 * error format.
 */
