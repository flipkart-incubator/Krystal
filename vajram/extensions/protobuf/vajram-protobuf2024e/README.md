...
`@SupportedModelProtocol`; the codegen here then emits an edition-2024 `.proto` schema and a
...
For a model root `Foo` (annotated `@SupportedModelProtocol(Protobuf2024e.class)`) the framework
emits:
