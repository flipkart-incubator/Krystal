 ...
 * Multiple different @{@link VajramDef}s may {@link ConformsToTrait conform to} a VajramTrait. This
 * is similar to a {@link FunctionalInterface} in java, traits in scala and rust etc. Application
