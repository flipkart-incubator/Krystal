 ...
 * developer having to explicit set the annotation. This allows us to prevent many bugs and errors.
 * If a vajram depends on both a Read Vajram and a Write Vajram, Write takes precedence since a
 * vajram is a mutation vajram if ANY of its dependency mutate state. Another example of a
 * transitive is annotation is `@CallGraphDelegationMode`. In this case as well there is a clear
 * hierarchy of {@link ComputeDelegationMode}s allowing clients to resolve conflicts.
 */
@Retention(RUNTIME)
