...
public class GuiceFramework implements DependencyInjectionFramework {
  ...
  public GuiceFramework(LatticeApplication latticeApp, Module... modules) {
    this(latticeApp, ImmutableList.copyOf(modules));
  }

  private GuiceFramework(LatticeApplication latticeApp, ImmutableList<? extends Module> modules) {
              ...
              Guice.createInjector(
                  ...
                  new AbstractModule() {
                    ...
                    protected void configure() {
                      ...
                      binder()
                          .bind(DependencyInjectionFramework.class)
                          .toInstance(GuiceFramework.this);
                    }
                  }));
