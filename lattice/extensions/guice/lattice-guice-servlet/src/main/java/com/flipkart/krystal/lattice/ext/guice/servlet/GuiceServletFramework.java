...
public final class GuiceServletFramework extends GuiceFramework {
  public GuiceServletFramework(LatticeApplication latticeApp, Module... modules) {
  ...
  public Closeable openRequestScope(Bindings seedMap, ThreadingStrategy threadingStrategy) {
    if (threadingStrategy != ThreadingStrategy.POOLED_NATIVE_THREAD_PER_REQUEST) {
