...
import com.flipkart.krystal.lattice.graphql.rest.dispatch.GraphQlOperationDelegator;
    ...
    vajramDopant
        ...
        .registerTraitDispatchPolicies(
            new GraphQlOperationDispatch(
                vajramDopant.graph(), typeDefinitionRegistry, graphQlOperationVajrams));
    vajramDopant.configureKryonExecutor(
        new GraphQlOperationDelegator(graphQL, vajramDopant.graph()));
  }
