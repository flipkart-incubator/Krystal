...
import com.flipkart.krystal.lattice.samples.grpc.proto.sampleProtoService.ProtoMessage_Proto3;
...
class Proto3LatticeSampleTest {
  ...
  void allInputsProvided_success() {
    ...
    assertThat(result)
        ...
        .isEqualTo(ProtoMessage_Proto3.newBuilder().setCount(100).build());
  }
