...
class KrystalNodeExecutorTest {
    ...
    NodeDefinition nodeDefinition =
        nodeDefinitionRegistry.newNodeDefinition(
            ...
            newComputeLogic(
                    ...
                    dependencyValues -> ImmutableList.of("computed_value"))
                .nodeLogicId());

    Object result =
        timedGet(
            krystalNodeExecutor
                .executeNode(nodeDefinition.nodeId(), new NodeInputs(), new RequestId("req_1"))
                .responseFuture());
                        ...
                        dependencyValues ->
                            ImmutableList.of(
                                "computed_values: a=%s;b=%s;c=%s"
                                    .formatted(
                                        singleValue(dependencyValues.getValue("a"))
                                            .value()
                                            .orElseThrow(),
                                        singleValue(dependencyValues.getValue("b"))
                                            .value()
                                            .orElseThrow(),
                                        singleValue(dependencyValues.getValue("c"))
                                            .value()
                                            .orElseThrow())))
                    .nodeLogicId(),
                ImmutableMap.of(),
  ...
  void requestExecution_singleDependency_success() throws Exception {
    NodeDefinition n1 =
        nodeDefinitionRegistry.newNodeDefinition(
            ...
            newComputeLogic(
                    "n1_logic",
                    Collections.emptySet(),
                    dependencyValues -> ImmutableList.of("dependency_value"))
                .nodeLogicId());
    ...
    NodeDefinition n2 =
        nodeDefinitionRegistry.newNodeDefinition(
            ...
            newComputeLogic(
                    ...
                    dependencyValues ->
                        ImmutableList.of(
                            singleValue(dependencyValues.getValue("dep")).value().orElseThrow()
                                + ":computed_value"))
                .nodeLogicId(),
    ...
    Object results =
        timedGet(
            krystalNodeExecutor
                .executeNode(n2.nodeId(), new NodeInputs(), new RequestId("r1"))
                .responseFuture());

    assertEquals("dependency_value:computed_value", results);
  }

  private SingleValue<?> singleValue(Value value) {
  ...
  void requestExecution_multiLevelDependencies_success() throws Exception {
    ...
    nodeDefinitionRegistry.newNodeDefinition(
        l1Dep,
        newComputeLogic(l1Dep, Collections.emptySet(), dependencyValues -> ImmutableList.of("l1"))
            .nodeLogicId());
    ...
    nodeDefinitionRegistry.newNodeDefinition(
        ...
        newComputeLogic(
                ...
                dependencyValues ->
                    ImmutableList.of(
                        singleValue(dependencyValues.getValue("input")).value().orElseThrow()
                            + ":l2"))
            .nodeLogicId(),
                    ...
                    nodeDefinitionRegistry
                        .newNodeDefinition(
                            ...
                            newComputeLogic(
                                    ...
                                    dependencyValues ->
                                        ImmutableList.of(
                                            singleValue(dependencyValues.getValue("input"))
                                                    .value()
                                                    .orElseThrow()
                                                + ":final"))
                                .nodeLogicId(),
  ...
  private <T> NodeLogicDefinition<T> newComputeLogic(
    ...
    logicDefinitionRegistry.add(def);
    return def;
  }
}
