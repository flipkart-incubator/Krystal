...
import com.flipkart.krystal.krystex.test_vajrams.hello.Hello_ReqImmut;
import com.flipkart.krystal.krystex.test_vajrams.hello.Hello_ReqImmutPojo;
...
import com.flipkart.krystal.krystex.test_vajrams.hellofriendsv2.HelloFriendsV2_ReqImmut;
import com.flipkart.krystal.krystex.test_vajrams.hellofriendsv2.HelloFriendsV2_ReqImmutPojo;
import com.flipkart.krystal.krystex.test_vajrams.multihello.MultiHelloFriends_ReqImmutPojo;
import com.flipkart.krystal.krystex.test_vajrams.multihellov2.MultiHelloFriendsV2_ReqImmutPojo;
import com.flipkart.krystal.krystex.test_vajrams.mutualFriendsHello.MutualFriendsHello_ReqImmutPojo;
import com.flipkart.krystal.krystex.test_vajrams.userservice.TestUserInfo;
import com.flipkart.krystal.krystex.test_vajrams.userservice.TestUserService;
import com.flipkart.krystal.krystex.test_vajrams.userservice.TestUserService_ReqImmut;
import com.flipkart.krystal.krystex.test_vajrams.userservice.TestUserService_ReqImmutPojo;
...
class VajramKryonExecutorTest {
  ...
  public VajramKryonExecutorTest(
  ...
  void executeCompute_noDependencies_success() {
    kGraph = loadFromClasspath("com.flipkart.krystal.krystex.test_vajrams.hello");
    CompletableFuture<String> result;
    requestContext.requestId("vajramWithNoDependencies");
    try (VajramKryonExecutor krystexVajramExecutor =
        kGraph
            .build()
            .createExecutor(getExecutorConfig(kryonExecStrategy, graphTraversalStrategy))) {
  ...
  void executeIo_singleRequestNoBatcher_success() {
    kGraph = loadFromClasspath("com.flipkart.krystal.krystex.test_vajrams.userservice");
  ...
  void executeIo_withBatcherMultipleRequests_calledOnlyOnce() {
    kGraph =
        loadFromClasspath(
            "com.flipkart.krystal.krystex.test_vajrams.userservice",
            "com.flipkart.krystal.krystex.test_vajrams.hellofriends");
    kGraph.inputBatcherConfig(computeSharedBatcherConfig(vGraph, _v -> 3));
  ...
  void executeCompute_sequentialDependency_success() {
    kGraph =
        loadFromClasspath(
            "com.flipkart.krystal.krystex.test_vajrams.userservice",
            "com.flipkart.krystal.krystex.test_vajrams.friendsservice",
            "com.flipkart.krystal.krystex.test_vajrams.hellofriendsv2");
    ...
    try (VajramKryonExecutor krystexVajramExecutor =
      ...
      helloString =
          krystexVajramExecutor.execute(
              ...
              VajramExecutionConfig.builder().executionId("execution").build());
    }
    assertThat(helloString)
        .succeedsWithin(TIMEOUT)
        .isEqualTo(
    ...
    assertThatThrownBy(() -> MultiHelloFriendsV2_ReqImmutPojo._builder()._build())
        ...
        .hasMessage(
            "Mandatory data field 'userIds' of the model "
                + "'com.flipkart.krystal.krystex.test_vajrams.multihellov2.MultiHelloFriendsV2_ReqImmutPojo' does not have a value");
  }

  @Test
  void executeCompute_exceptionThrown_hasNoStacktrace() {
    var graph = loadFromClasspath("com.flipkart.krystal.krystex.test_vajrams").build();
    CompletableFuture<String> result;
    requestContext.requestId("vajramWithNoDependencies");
    try (VajramKryonExecutor krystexVajramExecutor =
  ...
  void executeCompute_exceptionThrownInDebugMode_hasStacktrace() {
    ...
    KrystalExecutorConfigBuilder executorConfig =
        getExecutorConfig(kryonExecStrategy, graphTraversalStrategy).debug(true);
    try (VajramKryonExecutor krystexVajramExecutor = graph.createExecutor(executorConfig)) {
      result =
          krystexVajramExecutor.execute(
              MultiHelloFriendsV2_ReqImmutPojo._builder().userIds(Set.of()).fail(true)._build());
    }
  ...
  void execute_multiResolverFanouts_permutesTheFanouts() throws Exception {
    kGraph =
        loadFromClasspath(
            ...
            "com.flipkart.krystal.krystex.test_vajrams.userservice",
            "com.flipkart.krystal.krystex.test_vajrams.hellofriends",
            "com.flipkart.krystal.krystex.test_vajrams.multihello");
    kGraph.inputBatcherConfig(
  ...
  void flush_singleDepthParallelDependencySharedInputBatcherConfig_flushes1Batcher(
    ...
    kGraph =
        loadFromClasspath(
            ...
            "com.flipkart.krystal.krystex.test_vajrams.hellofriends",
            "com.flipkart.krystal.krystex.test_vajrams.multihello");
    kGraph.inputBatcherConfig(computeSharedBatcherConfig(vGraph, _v -> 100));
    CompletableFuture<String> multiHellos;
    requestContext.requestId(testInfo.getDisplayName());
    try (VajramKryonExecutor krystexVajramExecutor =
        kGraph
  ...
  private KrystalExecutorConfigBuilder getExecutorConfig(
      KryonExecStrategy kryonExecStrategy, GraphTraversalStrategy graphTraversalStrategy) {
    KrystalExecutorConfigBuilder krystalExecutorConfigBuilder =
        KrystalExecutorConfig.builder()
    ...
    return krystalExecutorConfigBuilder.executorService(executorLease.get());
  }
  ...
  void close_sequentialDependency_flushesBatcher(TestInfo testInfo) {
    var kGraph =
        loadFromClasspath(
            ...
            "com.flipkart.krystal.krystex.test_vajrams.friendsservice",
            "com.flipkart.krystal.krystex.test_vajrams.hellofriendsv2",
            "com.flipkart.krystal.krystex.test_vajrams.multihellov2");
    kGraph.inputBatcherConfig(
  ...
  void flush_sequentialDependency_flushesSharedBatchers(TestInfo testInfo) {
    kGraph =
        loadFromClasspath(
            ...
            "com.flipkart.krystal.krystex.test_vajrams.friendsservice",
            "com.flipkart.krystal.krystex.test_vajrams.hellofriendsv2",
            "com.flipkart.krystal.krystex.test_vajrams.mutualFriendsHello");
    kGraph.inputBatcherConfig(computeSharedBatcherConfig(vGraph, vajramId -> 100));
    CompletableFuture<String> multiHellos;
    requestContext.requestId(testInfo.getDisplayName());
    try (VajramKryonExecutor krystexVajramExecutor =
        kGraph
  ...
  private KrystexGraphBuilder loadFromClasspath(String... packagePrefixes) {
    vGraph = getVajramGraphBuilder(packagePrefixes).build();
    return com.flipkart.krystal.krystex.KrystexGraph.builder().vajramGraph(vGraph);
  }

  private static VajramGraphBuilder getVajramGraphBuilder(String... packagePrefixes) {
    VajramGraphBuilder builder = com.flipkart.krystal.krystex.VajramGraph.builder();
