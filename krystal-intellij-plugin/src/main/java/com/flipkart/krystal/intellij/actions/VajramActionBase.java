...
abstract class VajramActionBase extends com.intellij.openapi.actionSystem.AnAction {
  ...
  protected abstract boolean isApplicable(PsiClass vajramClass);
  ...
  protected abstract void perform(Project project, PsiClass vajramClass, AnActionEvent e);

  protected static @Nullable PsiClass getVajramClass(AnActionEvent e) {
